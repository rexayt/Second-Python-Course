...
nome_da_funcao -> SEMPRE, com letras minúsculas, e se for nome composto, separado por unerdline(Snake Case);
...
Também abrimos o bloco de código com o já conhecido dois ponto (:) que é utilizado em Python para definir blocos.
"""

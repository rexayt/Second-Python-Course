...
Ou seja, pode sera cessado em todo o projeto.
...
# vai impedir que façamos acesso aos atributos sinalizados como privados foram da classe
...
# OBS: Em linguagens como o Java, os atributos conhecidos como attributos de classe aqui em Python

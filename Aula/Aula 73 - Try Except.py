...
Utilizamos o bloco try/except para tratar errors que podem ocorrer no nosso código.
...
OBS: Trarar erro de forma genérica não é a melhor forma de tratamento de erros.
...
try:
    ...
    print('Você está utilzando uma função inexistente')

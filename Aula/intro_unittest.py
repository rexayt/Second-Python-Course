...
Unidades indivíduais podem ser: funções, métodos, classes, módulos etc.
...
assertNoIsInstance(a, b)    a não é instância de b
...
# Para executar os testes com unittest no mod verbose

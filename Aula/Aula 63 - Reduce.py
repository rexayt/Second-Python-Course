...
(built-in). Agora temos que importar e utilizar esta função a partir do
módulo 'functools'
...
Assim como map() e filter(), a função reduce() recebe dois parâmetros a função
e o iterável.
...
A função reduce(), funciona da seguinte forma:
    ...
    passo1 mais o terceiro elemento e guarda o resultado.
...
Alternativamento, poderíamos ver a função reduce() como:

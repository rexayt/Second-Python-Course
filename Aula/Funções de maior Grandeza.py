...
que retornam outras funções como resultado ou mesmo que podemos passar funções como argumentos para outras funções, e até mesmo criar variáveis do tipo de funções nos nossos programas.
...
def faz_me_rir():
    def rir():
        return choice(('hahahahahahaha', 'kkkkkkkkkkkkkk', 'yayayayayayayaya'))
    return rir()
...
def faz_me_rir_novamente(pessoa):
    def dando_risada():
        risada = choice(('hahahahahahaha', 'kkkkkkkkkkkkkk', 'yayayayayayayaya'))
